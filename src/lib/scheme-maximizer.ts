...
export const SCHEMES: Scheme[] = [
  ...
  },
  {
    ...
    quantify: (p) => ((p.age ?? 60) >= 80 ? 6000 : 2400), valuationNote: '₹200/mo (60–79) or ₹500/mo (80+) central share; states often add more.',
  ...
  },
  {
    ...
    quantify: (p) => ((p.age ?? 18) >= 80 ? 6000 : 3600), valuationNote: '₹300/mo (18–79) or ₹500/mo (80+) central share for 80%+ disability.',
  ...
  },
  {
    ...
    quantify: (p) => ((p.age ?? 40) >= 80 ? 6000 : 3600), valuationNote: '₹300/mo (40–79) or ₹500/mo (80+) central share for BPL widows.',
  ...
  },
  {
    ...
    howToApply: 'Automatic for children in government & aided schools (Classes 1–8).',
  ...
  },
  {
    ...
    quantify: () => 130000, valuationNote: '₹1.20L–1.30L grant to build a pucca rural house (one-time).',
  ...
  },
  {
    ...
    quantify: () => 0, valuationNote: 'Loan of ₹10L–₹1Cr for SC/ST & women entrepreneurs. Loan access, not a grant. counted as ₹0.',
  ...
  },
  {
    ...
    quantify: () => 0, valuationNote: 'Guaranteed ₹1k–5k/mo pension from 60. funded by your own contributions, so counted as ₹0 free benefit.',
