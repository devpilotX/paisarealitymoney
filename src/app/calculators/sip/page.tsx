...
const SIP_FAQS = [
  ...
  { question: 'How much should I invest in SIP every month?', answer: 'A common guideline is to invest at least 15 to 20% of your take-home income, but the right amount depends on your goal and timeline. Work backwards from your target: enter the final amount you want and adjust the monthly figure until the projection matches.' },
  { question: 'What is a step-up SIP?', answer: 'A step-up SIP raises your monthly investment by a fixed percentage every year, usually in line with your salary growth. Even a small annual step-up can grow your final corpus a lot, because the extra amounts get more years to compound.' },
  { question: 'Can I stop or pause my SIP anytime?', answer: 'Yes. SIPs are flexible. You can pause, stop, increase, or reduce the amount at any time with no penalty. Stopping early means you miss long-term compounding, so it usually pays to stay invested through market ups and downs.' },
