...
const INFLATION_FAQS = [
  ...
  { question: 'How do I calculate the future cost of something?', answer: 'Enter today cost, an expected inflation rate, and the number of years. The calculator compounds the cost forward so you can see what the same item or goal is likely to cost in the future.' },
  { question: 'What inflation rate should I use for planning?', answer: 'For general long-term planning in India, 6% is a reasonable assumption. Education and healthcare costs have often risen faster, around 8 to 10%, so use a higher rate when planning for those specific goals.' },
  { question: 'How can I protect my money from inflation?', answer: 'Keep only short-term needs in cash or FDs, and invest long-term money in assets that have historically beaten inflation, such as equity mutual funds. Spreading across asset classes helps. This is general information, not advice.' },
];
