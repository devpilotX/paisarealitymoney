  ...
  return (
    <div className="container-main py-6">
      ...
      <p className="text-body mb-8 max-w-2xl">
        Advanced money tools that do the hard maths for you. They handle complex questions about retirement, debt, tax, and investing. All free, private, and run in your browser.
      </p>
